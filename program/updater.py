...
async def update_repo(_, message: Message):
    ...
    if update_avail:
        await msg.edit("👤 يمكن شراء بوت بحقوقك كامل \n\n• او نسخه سورس بحقوقك بأرخص الأسعار حسابي الوحيد : DEV_WELSON.")
        system("git pull -f && pip3 install -r requirements.txt")
        execle(sys.executable, sys.executable, "main.py", environ)
        return
    await msg.edit("My only **account on ** telegram [⸤𝘿̤𝙀̤𝙑̤ 𝙒̤𝙀̤𝙇̤𝙎̤𝙊̤𝙉̤ 𝘼̤5𝙊̤ 𝙊̤𝙓̤𝙄̤𝘿̤𝙄̤𝙔̤𝘼̤⸥ᵛ͢ᵎᵖ •](https://t.me/DEV_WELSON)", disable_web_page_preview=True)
